...
note content already goes through it — single save (`service.py:395`), batch save
(`service.py:538`), rename/move (`service.py:953`), `edit_many` (`service.py:1152`),
`delete_many`/reconcile (`service.py:1450`, `1585`), single-note tagging (`tags.py:165`),
